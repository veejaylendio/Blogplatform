                        ...
                        <div class="sm-manager-body">
                            <form action="{{ route('social.update', $social->id) }}" method="POST">
                                ...
                                <div class="sm-form-container">
                                    <h2 id="form-title">Edit Platform</h2>

                                    <div class="sm-form-group">
                                        <label class="sm-label" for="platformInput">Platform Name:</label>
                                        <input name="platformName" type="text" class="sm-input-text" id="platformInput" placeholder="Enter platform name" value="{{$social->platform}}" required>
                                    </div>

                                    <div class="sm-form-group">
                                        <label class="sm-label" for="urlInput">URL:</label>
                                        <input name="url" type="text" class="sm-input-text" id="urlInput" placeholder="Enter URL" value="{{$social->url}}" required>
                                    </div>
