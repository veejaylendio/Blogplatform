                            ...
                            <div class="sm-manager-body">
                                <form action="{{ route('social.store')}}" method="POST">
                                    ...
                                    <div class="sm-form-container">
                                        ...
                                        <div class="sm-form-group">
                                            <label class="sm-label" for="platformInput">Platform Name:</label>
                                            <input name="platformName" type="text" class="sm-input-text" id="platformInput" placeholder="Enter platform name" required>
                                        </div>

                                        <div class="sm-form-group">
                                            <label class="sm-label" for="urlInput">URL:</label>
                                            <input name="url" type="text" class="sm-input-text" id="urlInput" placeholder="Enter URL" required>
                                        </div>

                                        <div class="sm-button-container">
                                            <button id="saveButton" class="sm-button sm-save-btn">Add Platform</button>
                                ...
                                <table class="sm-platform-table" id="platformTable">
                                    ...
                                    <tbody id="platformTableBody">
                                        @foreach($socialURLValue as $socialURLValue)
                                            <tr>
